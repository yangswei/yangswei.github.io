...
## 使用git管理博客
[Blog-Growing](https://github.com/yangshiwei/Blog-Growing)是我管理博客的仓库地址。结构大致是:
...
你可以把我的的[Blog-Growing](https://github.com/yangshiwei/Blog-Growing) clone下来, 看看一些基本配置是怎么配置的。需要提醒的是, `要把主题下的.git给删除掉` , 当然了你也可以使用 `git submodule` 来管理, 具体的管理方法我这里就不做多的介绍了, 想了解的话可以私信我。
...
转载请注明：[潘柏信的博客](http://baixin) » [点击阅读原文](http://yangshiwei.top/2016/06/HEXO_Advanced/)